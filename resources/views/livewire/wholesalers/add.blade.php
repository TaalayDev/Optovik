    ...
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="">
                ...
                <form method="post" action="{{ route('wholesalers.add.request') }}" class="text-center border border-light p-5">
                    <div class="divider-new spacing-divider">
                        <h6 class="text-center text-uppercase black-text">Оптовик</h6>
                    </div>
